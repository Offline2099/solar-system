...
export const mass: Definition = {
  term: 'Mass',
  explanation: [
    " determines the strength of the gravitational force exerted by the body on other objects. It is also a measure of the body's inertia, or resistance to acceleration when a force is applied."
  ]
};
...
export const surfaceGravity: Definition = {
  ...
  explanation: [
    ' is the gravitational acceleration experienced at the surface of a celestial body at the equator. For planets with no well-defined surfaces, it is given at the 1\xa0bar pressure level in the atmosphere.'
  ]
};
...
export const escapeVelocity: Definition = {
  ...
  explanation: [
    ' is the minimum speed required for an object to escape from the gravitational pull of the celestial body.'
  ]
};
...
export const semiMajorAxis: Definition = {
  ...
  explanation: [
    ' of an elliptical orbit is the mean value of the maximum and minimum distances from the center.'
  ]
};
...
export const siderealPeriod: Definition = {
  ...
  explanation: [
    ' is the amount of time it takes for an astronomical object to rotate full 360° on its axis.'
  ]
};
...
export const synodicPeriod: Definition = {
  term: 'Synodic period',
  explanation: [
    ' is the amount of time it takes for an astronomical object to rotate once on its axis in relation to the body it orbits. This rotation is slightly different from 360°, since the direction to the body changes as the object moves along the orbit.'
  ]
};
...
export const axialTilt: Definition = {
  term: 'Axial tilt',
  explanation: [
    " is the angle between the object's rotational axis and the line perpendicular to its orbital plane."
  ]
};
...
export const galacticOrbitPeriod: Definition = {
  ...
  explanation: [
    ' is the amount of time it takes for a star to complete one orbit around the center of the galaxy.'
  ]
};
...
export const galacticOrbitSpeed: Definition = {
  ...
  explanation: [
    ' is the speed at which a star travels along its orbit around the center of the galaxy.'
  ]
};
